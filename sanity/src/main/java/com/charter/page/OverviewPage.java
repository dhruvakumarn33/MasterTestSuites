...
public class OverviewPage extends WebDriverBase {
	...
	private static String UpgradeLink=ReadFromExcel.getLocator("OverviewPage", "UpgradeLink");
	...
	private static String SSection=ReadFromExcel.getLocator("OverviewPage","SSection");
	...
	public boolean RefreshDevicesLink(){
		...
		boolean retVal=false;
		WebElement plusicontv = driver.findElement(By.xpath("/html/body/div[1]/section/div[2]/div/div[3]/section/div/div/div/div/div/div[1]/section/div[2]/a/i"));
		plusicontv.click();
		WebElement refreshlink = driver.findElement(By.xpath("/html/body/div[1]/section/div[2]/div/div[3]/section/div/div/div/div/div/div[1]/section/div[1]/div[3]/div[2]/div[1]/ul/li[1]/div/button"));
		refreshlink.click();
	...
	public boolean SecuritySuiteLink(){
		...
		boolean retVal=false;
		WebElement securitylink = driver.findElement(By.xpath("/html/body/div[1]/section/div[2]/div/div[3]/section/div/div/div/div/div/div[2]/section/div[1]/div[2]/div[2]/a"));
		securitylink.click();
	...
	public boolean TV_Internet_Voice_DetailsLink(){
		...
		driver.navigate().back();
		wait(Until.elementToBeClickable(Internetlink));
		clickOnElement(Internetlink);
		System.out.println(driver.getCurrentUrl());
		//driver.get("https://www.charter.net/my-account/");
		driver.navigate().back();
		wait(Until.elementToBeClickable(Voicelink));
		clickOnElement(Voicelink);
		System.out.println(driver.getCurrentUrl());
		retVal =true;
	...
	public boolean BTPage_PaybillLink(){
		...
		WebElement paybilllink = driver.findElement(By.xpath("/html/body/div[1]/section/div/div[4]/section[1]/div/div/section[1]/div/a"));
		paybilllink.click();
		retVal=true;
		return retVal;
	}
	...
	public boolean AvatarImages(){
		boolean retVal = false;
		WebElement wHOH= driver.findElement(By.xpath("/html/body/div[1]/section/div[2]/div/div[5]/section/div/div[2]/div[1]/div[1]/ul/li[1]/div/div/div/img"));
		wHOH.click();
		WebElement wStandard=driver.findElement(By.xpath("/html/body/div[1]/section/div/div/section[1]/div[1]/div/div/div[2]/div[1]/div[1]/ul/li[3]/div/div/div/img"));
		wStandard.click();
		WebElement wAdmin=driver.findElement(By.xpath("/html/body/div[1]/section/div/div/section[1]/div[1]/div/div/div[2]/div[1]/div[1]/ul/li[2]/div/div/div/img"));
		wAdmin.click();
		return retVal;
	}

	public boolean TV_Internet_UpgradeLink() throws InterruptedException{
		boolean retVal=false;
		WebElement plusicon = driver.findElement(By.xpath("/html/body/div[1]/section/div[2]/div/div[3]/section/div/div/div/div/div/div[2]/section/div[2]/a/i"));
		plusicon.click();
		WebElement upgradebtn = driver.findElement(By.xpath("/html/body/div[1]/section/div[2]/div/div[3]/section/div/div/div/div/div/div[2]/section/div[1]/div[3]/div[3]/div[1]/a"));
		upgradebtn.click();
