...
public class UserPreferencePage extends WebDriverBase{
	...
	public void selectuser(userType selectiontype,String user){
		...
		String userlistlocator = "xpath;//div[contains(@class,'user-pref-carousel')]/div[1]/ul/li";
		String outercontainer = "xpath;//div[contains(@class,'user-pref-carousel')]/div[1]";
		...
		case role:
			userToSelect = "xpath;//div[contains(@class,'user-pref-carousel')]/div[1]/ul/li//div[contains(@class,'user-avatar')]/p/span[text()='"+user+"']";
			break;
		case username:
	...
	public boolean deleteUser(){
		...
		if(isElementPresent(btnDeleteUser)){
		...
		screenshot.saveScreenshot("Delete User"+ File.separator + "Clicked on Delete button");
		sleep(5);
	...
	public void select_PC_TV(String PC_TV){
		...
		screenshot.saveScreenshot("T518044"+ File.separator + "Tv & Movies List");
		sleep(3);
		if(PC_TV.equalsIgnoreCase("TV_Y"))
		{
			clickOnElement(TV_Y);
			screenshot.saveScreenshot("T518044"+ File.separator + "TV_Y");
		}

		if(PC_TV.equalsIgnoreCase("TV_7"))
		{
			clickOnElement(TV_7);
			screenshot.saveScreenshot("T518044"+ File.separator + "TV_7");
		}
		if(PC_TV.equalsIgnoreCase("TV_7_FV")){
			clickOnElement(TV_7_FV);
			screenshot.saveScreenshot("T518044"+ File.separator + "TV_7_FV");
		}
		if(PC_TV.equalsIgnoreCase("TV_G"))
		{
			clickOnElement(TV_G);
			screenshot.saveScreenshot("T518044"+ File.separator + "TV_G");
		}
		if(PC_TV.equalsIgnoreCase("TV_PG"))
		{
			clickOnElement(TV_PG);
			screenshot.saveScreenshot("T518044"+ File.separator + "TV_PG");
		}
		if(PC_TV.equalsIgnoreCase("TV_14"))
		{
			clickOnElement(TV_14);
			screenshot.saveScreenshot("T518044"+ File.separator + "TV_14");
		}
		if(PC_TV.equalsIgnoreCase("TV_MA"))
		{
			clickOnElement(TV_MA);
			screenshot.saveScreenshot("T518044"+ File.separator + "TV_MA");
		}
		return;
	}
	...
	public void Select_PC_Movie(String PC_Movie){
		...
		{
			clickOnElement(weG);
			screenshot.saveScreenshot("T518044"+ File.separator + "G");
		}

		if(PC_Movie.equalsIgnoreCase("PG"))
		{
			clickOnElement(wePG);
			screenshot.saveScreenshot("T518044"+ File.separator + "PG");
		}

		if(PC_Movie.equalsIgnoreCase("PG_13"))
		{
			clickOnElement(wePG_13);
			screenshot.saveScreenshot("T518044"+ File.separator + "PG_13");
		}

		if(PC_Movie.equalsIgnoreCase("R"))
		{
			clickOnElement(weR);
			screenshot.saveScreenshot("T518044"+ File.separator + "R");
		}

		if(PC_Movie.equalsIgnoreCase("NC_17"))
		{
			clickOnElement(weNC_17);
			screenshot.saveScreenshot("T518044"+ File.separator + "NC_17");
		}
	...
	public void selectAllowUnratedContent(String PC_Unratedcontent){
		...
		if(isElementPresent(parentalsavBtn)){
			screenshot.saveScreenshot("T518044"+ File.separator + "Save Button");
	...
	public void Promote_Selected_User(String Account_Type){
		...
		screenshot.saveScreenshot("Promote"+ File.separator + "Account Controls");
		sleep(5);
		if(Account_Type.equalsIgnoreCase("HOH")){
			clickOnElement(chkboxHOH);
			screenshot.saveScreenshot("Promote"+ File.separator + "HOH");
		}

		if(Account_Type.equalsIgnoreCase("Admin")){		    	

			clickOnElement(chkboxAdmin);
			screenshot.saveScreenshot("Promote"+ File.separator + "Admin");
		}

		if(Account_Type.equalsIgnoreCase("Standard")){

			clickOnElement(chkboxStandard);
			screenshot.saveScreenshot("Promote"+ File.separator + "Standard");
		}    

		clickOnElement(accountCtrlsavebtn);
		screenshot.saveScreenshot("Promote"+ File.separator + "clicked Save Button");
	...
	public void Demote_Selected_User(String Account_Type){
		...
		clickOnElement(accountctrlPlusbtn);
		screenshot.saveScreenshot("Demote"+ File.separator + "Account Controls");
		if(Account_Type.equalsIgnoreCase("Standard")){

			sleep(5);
			clickOnElement(chkboxStandard);
			screenshot.saveScreenshot("Demote"+ File.separator + "Checked Standard");
		}    

		clickOnElement(accountCtrlsavebtn);
		screenshot.saveScreenshot("Demote"+ File.separator + "clicked on Save Button");
		if(isElementPresent(btnOK))
		{
			clickOnElement(btnOK);
		}
	...
	public boolean BillingAddress_Edit(String Address1,String Address2,String City,String State,String Zipcode){
